...
<header class="header">
    ...
    <a href="home.html" class="logo"> <i class="fas fa-shopping-basket"></i> organic fruit </a>
...
<section class="category">
    ...
    <div class="box-container">
        ...
        <a href="#" class="box">
            <img src="${urlImage }cat-1.png" alt="">
            <h3>fresh fruits</h3>
        </a>

        <a href="#" class="box">
            <img src="${urlImage }cat-2.png" alt="">
            <h3>vegetables</h3>
        </a>

        <a href="#" class="box">
            <img src="${urlImage }cat-3.png" alt="">
            <h3>organic spices</h3>
        </a>

        <a href="#" class="box">
            <img src="${urlImage }cat-4.png" alt="">
            <h3>fresh meat</h3>
        </a>

        <a href="#" class="box">
            <img src="${urlImage }cat-5.png" alt="">
            <h3>organic wheat</h3>
        </a>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-1.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-2.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-3.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-4.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-5.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-6.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-7.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="${urlImage }product-8.jpg" alt="">
            </div>
            <div class="content">
                <h3>organic food</h3>
                <div class="price">$18.99</div>
