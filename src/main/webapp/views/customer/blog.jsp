...
<section class="blogs">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-1.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-2.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fas fa-calendar"></i> 21st may, 2021 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-3.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fas fa-calendar"></i> 21st may, 2021 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-4.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fas fa-calendar"></i> 21st may, 2021 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-5.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fas fa-calendar"></i> 21st may, 2021 </a>
        ...
        <div class="box">
            <div class="image">
                <img src="${urlImage }blog-6.jpg" alt="">
            </div>
            <div class="content">
                <div class="icons">
                    <a href="#"> <i class="fas fa-calendar"></i> 21st may, 2021 </a>
